...
python run_expt.py  --seed 2023   --moo_method mgda --log_every 50   --num_tokens 10  --lr .3 --batch_size 64 --weight_decay 0.001 --alpha 1.5 --model imagenet21k_ViT-B_16  --n_epochs 100 --data_dir /scratch/hvp2011/implement/spurious-correlation/data/waterbird_complete95_forest2water2 

# python run_expt.py  --seed 0  --moo_method epo --preference 1 1 1 1 --log_every 50   --num_tokens 10  --lr .001 --batch_size 32 --weight_decay 0.0001 --alpha 2 --model imagenet_resnet50_pretrained  --n_epochs 100 --data_dir /scratch/hvp2011/implement/spurious-correlation/data/waterbird_complete95_forest2water2 
# python run_expt.py  --seed 0   --moo_method bgda --log_every 50   --num_tokens 10  --lr .001 --batch_size 64 --weight_decay 0.001 --alpha 1. --model imagenet_resnet50_pretrained  --n_epochs 100 --data_dir /scratch/hvp2011/implement/spurious-correlation/data/waterbird_complete95_forest2water2 
# python run_expt.py  --seed 2  --moo_method epo --preference 1 1 1 1 --log_every 50   --num_tokens 10  --lr .001 --batch_size 64 --weight_decay 0.001 --alpha 2 --model imagenet_resnet50_pretrained  --n_epochs 100 --data_dir /scratch/hvp2011/implement/spurious-correlation/data/waterbird_complete95_forest2water2 
