...
python run_expt.py  --seed 0   --moo_method epo --preference 1 1 1 1 --log_every 50   --num_tokens 10  --lr .001 --batch_size 64 --weight_decay 0.001 --alpha 1. --model imagenet_resnet50_pretrained  --n_epochs 100 --data_dir /scratch/hvp2011/implement/spurious-correlation/data/waterbird_complete95_forest2water2 
