...
python run_expt.py --seed 0 --moo_method epo --preference 1 1 1 1 --lr .00025 --batch_size 128 --weight_decay 0.0001 --model imagenet_resnet50_pretrained --warmup 0 --n_epochs 100   --data_dir /scratch/hvp2011/implement/spurious-correlation/data/waterbird_complete95_forest2water2    
# python run_expt.py --seed 0 --moo_method imtl   --lr .001 --batch_size 128 --weight_decay 0.0001 --model imagenet_resnet50_pretrained --warmup 0 --n_epochs 100   --data_dir /scratch/hvp2011/implement/spurious-correlation/data/waterbird_complete95_forest2water2    

# python run_expt.py --seed 0  --moo_method epo --preference 1 1 1 1 --log_every 50   --num_tokens 3  --lr .01 --batch_size 64 --weight_decay 0.001 --model imagenet21k_ViT-B_16  --n_epochs 100 --data_dir /scratch/hvp2011/implement/spurious-correlation/data/waterbird_complete95_forest2water2 
# python run_expt.py  --seed 0  --moo_method ew --log_every 50   --num_tokens 3  --lr .01 --batch_size 64 --weight_decay 0.001 --model imagenet21k_ViT-B_16  --n_epochs 100 --data_dir /scratch/hvp2011/implement/spurious-correlation/data/waterbird_complete95_forest2water2 
