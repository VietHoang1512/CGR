...
python run_expt.py --log_dir logs/celebA/prompt/epo/1,1,2,1/sgd/scheduler/ --seed 0  --moo_method epo --preference 1 1 2 1  --num_tokens 10  --lr .1 --batch_size 128 --weight_decay 0.0001 --model imagenet21k_ViT-B_16 --warmup 10 --n_epochs 50 --log_every 200 --reweight_groups    -s confounder -d CelebA  --root_dir /scratch/hvp2011/implement/spurious-correlation/data/celebA  -t Blond_Hair -c Male
