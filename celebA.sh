...
# python run_expt.py --seed 0  --moo_method epo --preference 1 1 1 1 --num_tokens 15  --lr .1 --batch_size 128 --alpha 1 --weight_decay 0.001 --model imagenet21k_ViT-B_16 --warmup 10 --n_epochs 50 --log_every 200 
