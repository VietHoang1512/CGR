...
python run_expt.py --seed 2  --moo_method epo --preference 1 1 1 1   --num_tokens 10  --lr .001 --batch_size 128 --alpha 1 --weight_decay 0.0001 --model imagenet_resnet50_pretrained --warmup 10 --n_epochs 50 --log_every 200 --data_dir /scratch/hvp2011/implement/spurious-correlation/data/celebA
