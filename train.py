...
def run_epoch(epoch, model, criterion, optimizer, train_loader, test_loader_dict, get_ys_func, args, log_every=50, scheduler=None, best_val_wga=0, best_test_wga=0):
    ...
    train_acc_groups = {g_idx: utils.AverageMeter() for g_idx in range(n_groups)}
    ...
    for batch_idx, batch in enumerate(prog_bar_loader):
        ...
        loss = loss_computer.compute_grads(
            losses, model, args)
