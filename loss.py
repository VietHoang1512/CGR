import torch
from weight_methods import MGDA, PCGrad, CAGrad, IMTL, EW
...
class LossComputer:
    def __init__(self, criterion,  dataset):
    ...
    def loss(self, yhat, y, group_idx=None, is_training=False):
        ...
        self.update_stats(group_loss, group_acc, group_count, None)
        if is_training:
            return group_loss
    ...
    def set_gradient(self, model, grad):
        ...
        for name, param in model.named_parameters():
            ...
            offset += numel
        assert offset == grad.numel(), f"Size mismatched {offset} != {grads.numel()}"
    ...
    def update_stats(self, group_loss, group_acc, group_count, weights=None):
        # avg group loss
    ...
    def log_stats(self, logger, is_training):
        ...
        logger.write(f'Average sample loss: {self.avg_group_loss.mean().item():.3f}  \n')
